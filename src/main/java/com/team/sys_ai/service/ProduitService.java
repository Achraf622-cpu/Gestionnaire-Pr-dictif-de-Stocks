...
public class ProduitService {
    ...
    /**
     * Get all active products (non-paginated - for backward compatibility).
     */
    ...
    /**
     * Get all products for admin (non-paginated - for backward compatibility).
     */
     ...
     */
    public Page<ProduitAdminDTO> getAllProduitsForAdmin(Pageable pageable) {
        return produitRepository.findByActifTrue(pageable)
                .map(produitMapper::toAdminDTO);
    }
    ...
    public Page<ProduitDTO> getProduitsByCategorie(String categorie, Pageable pageable) {
        return produitRepository.findByCategorieAndActifTrue(categorie, pageable)
                .map(produitMapper::toDTO);
    }
     ...
     */
    public Page<ProduitDTO> searchProduits(String nom, Pageable pageable) {
